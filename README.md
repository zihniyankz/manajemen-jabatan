...
3. Copy file `.env.example` jadi `.env` lalu atur konfigurasi database
4. Jalankan migrasi database: `php artisan migrate`
5. Jalankan server dengan `php artisan serve` atau via Laragon
...
Zihni Yankz  
GitHub: [zihniyankz](https://github.com/zihniyankz)
...
64d8455 (First commit - Manajemen Jabatan Laravel Project)
